...
Usage::
    ...
    uv run python -m moo.zil_import.scripts.zork1_reset
    uv run python -m moo.zil_import.scripts.zork1_reset --hostname zork1.local
"""
...
from moo.zil_import.scripts.zork1_smoke import _REPO_ROOT, _RESET_SNIPPET
