...
Usage::
    ...
    uv run python -m moo.zil_import.scripts.zork1_save_state
    uv run python -m moo.zil_import.scripts.zork1_save_state --output snap.json
    uv run python -m moo.zil_import.scripts.zork1_save_state --hostname zork1.local
"""
