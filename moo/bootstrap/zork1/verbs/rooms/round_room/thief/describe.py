...
if not mode:
    if the_player_verb in ["hello", "hi"] and this.getp("description") == player.zstate_get("ROBBER-U-DESC"):
        ...
        (parser.get_dobj() if parser.has_dobj_str() else None) == lookup("knife")
        and the_player_verb in ["throw", "toss"]
        and not this.flag("hostile")
    ):
        ...
        and not (parser.get_dobj() if parser.has_dobj_str() else None) == this
        ...
        (parser.get_dobj() if parser.has_dobj_str() else None).moveto(this)
        if (parser.get_dobj() if parser.has_dobj_str() else None).getp("tvalue") > 0:
