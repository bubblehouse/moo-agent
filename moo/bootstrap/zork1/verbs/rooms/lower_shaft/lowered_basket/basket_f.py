#!moo verb basket_f --on "basket (LOWERED-BASKET)" --dspec none
...
if the_verb == "raise":
    if player.zstate_get("CAGE-TOP"):
        ...
        raised_basket.moveto(shaft_room)
        this.moveto(lower_shaft)
        player.zstate_set("CAGE-TOP", True)
        # ZIL: <THIS-IS-IT ...>
        _.thing.this_is_it(raised_basket)
    ...
    if not player.zstate_get("CAGE-TOP"):
        ...
        raised_basket.moveto(lower_shaft)
