...
if the_player_verb == "exorcise":
    ...
    not player.zstate_get("LLD-FLAG")
    and the_player_verb == "ring"
    and (parser.get_dobj() if parser.has_dobj_str() else None) == bell
):
    ...
    player.zstate_get("XC")
    and the_player_verb == "read"
    and (parser.get_dobj() if parser.has_dobj_str() else None) == book
    and not player.zstate_get("LLD-FLAG")
):
    print(
