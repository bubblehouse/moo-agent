#!moo verb jigs_up --on "Zork Thing" --dspec this
...
if not player.zstate_get("DEATHS") < 2:
    ...
    if lookup("south_temple").flag("touchbit"):
        ...
        player.set_property("action", _.zork_thing.dead_function())
    ...
    _.zork_thing.randomize_objects()
    # ZIL: <KILL-INTERRUPTS ...>
    _.zork_thing.kill_interrupts()
    # ZIL: <RFATAL ...>
    return 2
