#!moo verb pull tug yank move roll --on "Actor" --dspec either

# Generated by moo/zil_import — do not edit by hand
# pylint: disable=return-outside-function,undefined-variable,no-name-in-module

"""Player command for PULL: delegate to V-MOVE."""
...
compound_table = {
    "pull": {"on": "move", "up": "move"},
    "tug": {"on": "move", "up": "move"},
    "yank": {"on": "move", "up": "move"},
    "move": {"on": "move", "up": "move"},
    "roll": {"on": "move", "up": "move"},
}
