#!moo verb examine describe what whats --on "Actor" --dspec either

# Generated by extras/zil_import — do not edit by hand
# pylint: disable=return-outside-function,undefined-variable,no-name-in-module

"""Player command for EXAMINE: delegate to V-EXAMINE."""
...
compound_table = {
    "examine": {"in": "look_inside", "on": "look_inside"},
    "describe": {"in": "look_inside", "on": "look_inside"},
    "what": {"in": "look_inside", "on": "look_inside"},
    "whats": {"in": "look_inside", "on": "look_inside"},
}
