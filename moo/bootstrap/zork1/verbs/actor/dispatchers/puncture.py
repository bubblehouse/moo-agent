#!moo verb puncture destroy damage break block smash poke --on "Actor" --dspec either

# Generated by moo/zil_import — do not edit by hand
# pylint: disable=return-outside-function,undefined-variable,no-name-in-module

"""Player command for PUNCTURE: delegate to V-MUNG."""
...
compound_table = {
    "puncture": {"down": "mung", "in": "open"},
    "destroy": {"down": "mung", "in": "open"},
    "damage": {"down": "mung", "in": "open"},
    "break": {"down": "mung", "in": "open"},
    "block": {"down": "mung", "in": "open"},
    "smash": {"down": "mung", "in": "open"},
    "poke": {"down": "mung", "in": "open"},
}
